...
export default function NavBlock(){
    return(
        <div id = "navBlockContainer">
            ...
            <div className = "navCard" style = {{backgroundImage: "url(https://firebasestorage.googleapis.com/v0/b/school70site.appspot.com/o/nav%2FEvents.PNG?alt=media&token=0d44e4a2-33b5-4331-bceb-ca15c4d91bb1)"}}><Link to = '/events'>Events</Link></div>
